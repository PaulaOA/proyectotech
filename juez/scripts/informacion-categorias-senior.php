...
$sql_items_2 = "SELECT * FROM items_senior WHERE id_categoria = 2";
$items_categoria2 = $conn->query($sql_items_2);

$sql_items_3 = "SELECT * FROM items_senior WHERE id_categoria = 3";
$items_categoria3 = $conn->query($sql_items_3);

$sql_items_4 = "SELECT * FROM items_senior WHERE id_categoria = 4";
$items_categoria4 = $conn->query($sql_items_4);

$sql_items_5 = "SELECT * FROM items_senior WHERE id_categoria = 5";
